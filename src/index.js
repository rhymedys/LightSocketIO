 ...
 */
  ...
  /**
   * @description 遍历CallbackMap
   * @param {any} type 事件类型
   * @param {any} currentTarget 事件响应回调
   * @memberof SocketIO
   */
  ...
  addCallback(eventTypeCallback, eventKey, eventCallback) {
    if (eventTypeCallback && eventKey && eventCallback instanceof Function) {
      ...
      this.throwError('eventTypeCallback should be a function or eventKey should not be null')
    }
